...
class SeasonProgressed(Event):
    ...
    @property
    def routing_key(self) -> str:
        return "almanac.season.progressed"
...
class TemperatureChanged(Event):
    ...
    @property
    def routing_key(self) -> str:
        return f"almanac.temperature.changed.{self.region_slug}"
...
class WeatherStarted(Event):
    ...
    @property
    def routing_key(self) -> str:
        return f"almanac.weather.{self.condition}.started.{self.region_slug}"
...
class WeatherStopped(Event):
    ...
    @property
    def routing_key(self) -> str:
        return f"almanac.weather.{self.condition}.stopped.{self.region_slug}"
